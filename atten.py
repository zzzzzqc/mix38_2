...
class SpatialAttention(nn.Module):
    def __init__(self, in_channel):
        ...
        self.conv_l1 = nn.Conv2d(in_channels=int(self.in_channel // 2), out_channels=1, kernel_size=(3, 1), stride=1,
                                 padding=(1, 0))
        self.conv_l2 = nn.Conv2d(in_channels=1, out_channels=1, kernel_size=(1, 3), stride=1, padding=(0, 1))
        self.conv_r1 = nn.Conv2d(in_channels=int(self.in_channel // 2), out_channels=1, kernel_size=(1, 3), stride=1,
                                 padding=(0, 1))
        self.conv_r2 = nn.Conv2d(in_channels=1, out_channels=1, kernel_size=(3, 1), stride=1, padding=(1, 0))
        self.conv_layer = nn.Conv2d(in_channels=self.in_channel, out_channels=self.in_channel, kernel_size=3, groups=2,
                                    padding=1)
